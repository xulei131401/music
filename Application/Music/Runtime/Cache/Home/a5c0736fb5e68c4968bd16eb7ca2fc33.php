...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
  <tr>
    ...
    <form method="post" action="<?php echo U('Home/Web/editState');?>" enctype="multipart/form-data">
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
      ...
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        ...
        <?php if($web['state'] == 1): ?><input type="radio" name="state" value="1" checked="checked">开启
          <input type="radio" name="state" value="0" >关闭
        <?php else: ?>
          <input type="radio" name="state" value="1" >开启
