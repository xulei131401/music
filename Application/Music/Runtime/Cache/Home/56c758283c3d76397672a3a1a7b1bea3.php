...
/*.pagination{position: absolute;top: 700px;left: 500px;z-index: 4}*/
</style>
</head>
<body>
<!--main_top-->
  ...
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
      <tr>
        ...
        <th align="center" valign="middle" class="borderright">职位名称</th>
        <th align="center" valign="middle" class="borderright">职位类别</th>
        <th align="center" valign="middle" class="borderright">招聘人数</th>
        <th align="center" valign="middle" class="borderright">工作地点</th>
        <th align="center" valign="middle" class="borderright">发布时间</th>
        <th align="center" valign="middle">操作</th>
      </tr>
      <?php if(is_array($employee)): $i = 0; $__LIST__ = $employee;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="bggray" onMouseOut="this.style.backgroundColor='#f9f9f9'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        ...
        <td align="center" valign="middle" class="borderright borderbottom"><?php echo ($vo["cate"]); ?></td>
        <td align="center" valign="middle" class="borderright borderbottom"><?php echo ($vo["num"]); ?></td>
        <td align="center" valign="middle" class="borderright borderbottom"><?php echo ($vo["address"]); ?></td>
        <td align="center" valign="middle" class="borderright borderbottom"><?php echo ($vo["regtime"]); ?></td>
        <td align="center" valign="middle" class="borderbottom"><a href="<?php echo U('Home/Employee/edit',array('id'=>$vo['id']));?>" target="_self" onFocus="this.blur()" class="add">编辑</a><span class="gray">&nbsp;|&nbsp;</span><a href="<?php echo U('Home/Employee/delete',array('id'=>$vo['id']));?>" target="_self" onFocus="this.blur()" class="add">删除</a></td>
