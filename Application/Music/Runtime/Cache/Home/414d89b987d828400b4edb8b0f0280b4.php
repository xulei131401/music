  ...
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="search">
  		<tr>
           ...
           <td width="10%" align="center" valign="middle" style="text-align:right; width:150px;"><a href="<?php echo U('Home/Goodsong/add',array('id'=>$good['id']));?>" target="_self" onFocus="this.blur()" class="add">新增歌曲</a></td>
         </td>
  		</tr>
	</table>
    <!-- 歌曲查询要做 -->
    ...
    <!-- 循环所有歌曲 -->
      <?php if(is_array($songlist)): foreach($songlist as $key=>$vo): ?><tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        ...
        <td align="center" valign="middle" class="borderbottom">
              <a href="<?php echo U('Home/Goodsong/del',array('id'=>$good['id'],'song_id'=>$vo['id']));?>">删除</a>
        </td>
      </tr>
