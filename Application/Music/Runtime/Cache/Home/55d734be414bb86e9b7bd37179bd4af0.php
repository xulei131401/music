 ...
 <table class="table table-striped table-bordered table-hover" id="sample_table">
		<thead>
		 <tr>
				...
				<th width="80px">会员账号</th>
				<th width="250px">会员真实名字</th>
	...
	<tbody>
	<?php if(is_array($user_show)): $i = 0; $__LIST__ = $user_show;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
     ...
     <td class="td-status">
      ...
      <td class="td-manage">
       <a  href="<?php echo U('Home/User/status',array('status'=>$vo['status'], 'id'=>$vo['id']));?>" title="状态按钮"  class="btn btn-xs btn-success"><i class="fa fa-check  bigger-120"></i></a>  
        <a title="编辑"  target="_self" href="<?php echo U('Home/User/edit',array('id'=>$vo['id']));?>"  class="btn btn-xs btn-info" ><i class="fa fa-edit bigger-120"></i></a>       
...
function member_del(obj,id){
	layer.confirm('确认要删除吗？',function(index){
		...
		location.href="<?php echo U('Home/User/delete',array('id'=>$vo['id']));?>";
	});
}
</script>