     ...
     <div class="type_title">管理员信息 </div>
      <div class="xinxi">
        <div class="form-group"><label class="col-sm-3 control-label no-padding-right" for="form-field-1">用户名： </label>
          <div class="col-sm-9"><input type="text" name="用户名" id="website-title" value="<?php echo ($info['realname']); ?>" class="col-xs-7 text_info" disabled="disabled">
          ...
          <div class="col-sm-9">
          <?php if($info['sex'] == 0): ?><span class="sex">男</span>
            <?php else: ?>
            <span class="sex">女</span><?php endif; ?>
            <div class="add_sex">
             <?php if($info['sex'] == 0): ?><label><input name="form-field-radio" type="radio" class="ace" checked="checked"><span class="lbl">男</span></label>&nbsp;&nbsp;
              <label><input name="form-field-radio" type="radio" class="ace"><span class="lbl">女</span></label>
              <?php else: ?>
                <label><input name="form-field-radio" type="radio" class="ace"><span class="lbl">男</span></label>&nbsp;&nbsp;
              <label><input name="form-field-radio" type="radio" class="ace" checked="checked"><span class="lbl">女</span></label><?php endif; ?>
            </div>
           </div>
          </div>

          <div class="form-group"><label class="col-sm-3 control-label no-padding-right" for="form-field-1">年龄： </label>
          <div class="col-sm-9"><input type="text" name="年龄" id="website-title" value="<?php echo ($info['age']); ?>" class="col-xs-7 text_info" disabled="disabled"></div>
          </div>
          <div class="form-group"><label class="col-sm-3 control-label no-padding-right" for="form-field-1">移动电话： </label>
          <div class="col-sm-9"><input type="text" name="移动电话" id="website-title" value="<?php echo ($info['tel']); ?>" class="col-xs-7 text_info" disabled="disabled"></div>
          </div>
          <div class="form-group"><label class="col-sm-3 control-label no-padding-right" for="form-field-1">电子邮箱： </label>
          <div class="col-sm-9"><input type="text" name="电子邮箱" id="website-title" value="<?php echo ($info['email']); ?>" class="col-xs-7 text_info" disabled="disabled"></div>
          </div>
          ...
          <div class="col-sm-9"><input type="text" name="QQ" id="website-title" value="456789787" class="col-xs-7 text_info" disabled="disabled"> </div>
           ...
           <div class="form-group"><label class="col-sm-3 control-label no-padding-right" for="form-field-1">角色： </label>
            <div class="col-sm-9" >
              <?php if($info['vip'] == 1): ?><span>超级管理员</span>
              <?php else: ?>
          ...
          <div class="col-sm-9" > <span><?php echo ($info['regtime']); ?></span></div>
          </div>
