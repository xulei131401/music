...
<div class="page-content clearfix">
    <div id="Member_Ratings">
     ...
     <form  action="<?php echo U('Home/Admin/addHandle');?>" method="post" enctype="multipart/form-data">
		...
		<tr>
		 ...
		 <tr>
			<td width="30%">真实姓名:</td>
			<td><input type="text" name = "realname" placeholder="输入真实姓名"></td>
		</tr>
		<tr>
			<td width="30%">年龄:</td>
		...
		<tr>
			<td width="30%">手机:</td>
			<td><input type="text" name = "tel" placeholder="输入手机号"></td>
	    </tr>
	    <tr>
			<td width="30%">邮箱:</td>
		...
		<tr>
    		<td width="30%">地址:</td>
    		<td><input type="text" name = "address" placeholder="输入地址"></td>
    	</tr>
		<tr>
			<td width="30%">头像:</td>
			<td>
				<label for="input-file-now"></label>
				<input type="file" id="input-file-now" class="dropify" data-default-file="默认文件" name = "pic" />
			</td>
		</tr>
		<tr>
			<td width="30%">管理组:</td>
			<td>
				<?php if(is_array($group)): $i = 0; $__LIST__ = $group;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><input type="checkbox" name="access[]" value="<?php echo ($vo["id"]); ?>"/><?php echo ($vo["title"]); ?>&nbsp;&nbsp;<?php endforeach; endif; else: echo "" ;endif; ?>
           </td>
        </tr>
        <tr>
