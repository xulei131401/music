...
<div class="page-content clearfix">
  <div class="administrator">
	...
	<tbody>
	<?php if(is_array($admin_show)): $k = 0; $__LIST__ = $admin_show;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><tr>
      <td><label><input type="checkbox" class="ace"><span class="lbl"></span></label></td>
      <td><?php echo ($vo["id"]); ?></td>
      <td><?php echo ($vo["username"]); ?></td>
      <td><a href="<?php echo U('Home/Admin/editGroup',array('id'=>$vo['id']));?>" title="修改管理组"><?php echo ($vo["realname"]); ?></a></td>
      <td><?php echo ($vo["tel"]); ?></td>
      <td><?php echo ($vo["email"]); ?></td>
      <td>
      <?php if(is_array($title)): $k1 = 0; $__LIST__ = $title;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$t): $mod = ($k1 % 2 );++$k1; if($k1 == $k): echo ($t); endif; endforeach; endif; else: echo "" ;endif; ?>
      </td>
     ...
     <td class="td-status">
      ...
      <td class="td-manage">
       <a  href="<?php echo U('Home/Admin/status',array('status'=>$vo['status'], 'id'=>$vo['id']));?>" title="状态按钮"  class="btn btn-xs btn-success"><i class="fa fa-check  bigger-120"></i></a>   
        <a title="编辑"  target="_self" href="<?php echo U('Home/Admin/edit',array('id'=>$vo['id']));?>"  class="btn btn-xs btn-info" ><i class="fa fa-edit bigger-120"></i></a>       
...
// 		location.href="<?php echo U('Home/Admin/delete',array('id'=>$vo['id']));?>";
// 	});
// }
</script>