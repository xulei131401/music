...
<div class="page-content clearfix">
  <div class="administrator">
	...
	<tbody>
	<?php if(is_array($auth_show)): $i = 0; $__LIST__ = $auth_show;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
      ...
      <td class="td-manage">
        <a  href="<?php echo U('Home/Auth/status',array('status'=>$vo['status'], 'id'=>$vo['id']));?>" title="状态按钮"  class="btn btn-xs btn-success"><i class="fa fa-check  bigger-120"></i></a>  
        <a title="编辑"  target="_self" href="<?php echo U('Home/Auth/edit',array('id'=>$vo['id']));?>"  class="btn btn-xs btn-info" ><i class="fa fa-edit bigger-120"></i></a>       
        <a title="删除" href="<?php echo U('Home/Auth/delete',array('id'=>$vo['id']));?>" class="btn btn-xs btn-warning" ><i class="fa fa-trash  bigger-120"></i></a>
       </td>
...
// 		location.href="<?php echo U('Home/Auth/delete',array('id'=>$vo['id']));?>";
// 	});
// }
</script>