...
<!--main_top-->
  ...
  <tr>
    ...
    <form method="post" action="<?php echo U('Home/Admin/editGroup');?>">
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        ...
        <input type="text" name="title" class="text-word" value="<?php echo ($admin['username']); ?>" readonly="readonly">
        </td>
        </tr> 
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        <td align="right" valign="middle" class="borderright borderbottom bggray">管理组名称：</td>
        <td align="left" valign="middle" class="borderright borderbottom main-for">
            <?php if(is_array($groups)): foreach($groups as $key=>$group): ?><input type="checkbox" name="group[]" value="<?php echo ($group["id"]); ?>"/><?php echo ($group["title"]); ?>&nbsp;&nbsp;<?php endforeach; endif; ?>
        </td>
        </tr>
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
