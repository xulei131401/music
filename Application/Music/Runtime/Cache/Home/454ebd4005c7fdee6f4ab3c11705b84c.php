...
<div class="page-content clearfix">
    <div id="Member_Ratings">
     ...
     <form  action="<?php echo U('Home/Admin/editHandle');?>" method="post" enctype="multipart/form-data">
    	 <input type="hidden" value = "<?php echo ($admin['id']); ?>" name = "id"/>
         <table class="table table-striped table-bordered table-hover" id="sample-table">
		<thead>
		 <tr>
			<td width="30%">账号:</td>
			<td><input type="text" name = "username" placeholder="输入用户名" value = "<?php echo ($admin['username']); ?>"></td>
		</tr>
		<tr>
			<td width="30%">密码:</td>
			<td><input type="text" name = "password" placeholder="输入密码" value = "<?php echo ($admin['password']); ?>"></td>
		</tr>
		<tr>
			<td width="30%">手机:</td>
			<td><input type="text" name = "tel" placeholder="输入手机号" value = "<?php echo ($admin['tel']); ?>"></td>
	    </tr>
	    <tr>
			<td width="30%">邮箱:</td>
			<td><input type="text" name = "email" placeholder="输入邮箱" value = "<?php echo ($admin['email']); ?>"></td>
		</tr>
		<tr>
    		<td width="30%">地址:</td>
    		<td><input type="text" name = "address" placeholder="输入地址" value = "<?php echo ($admin['address']); ?>"></td>
    	</tr>
    	<tr>
			<td width="30%">原始头像:</td>
			<td>
				<img src="/music/<?php echo ($admin['pic']); ?>" width = "100" height = "100"><br/>
			</td>
		</tr>
		<tr>
			<td width="30%">新头像:</td>
