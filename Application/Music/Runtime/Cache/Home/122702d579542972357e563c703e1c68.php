...
<div class=" page-content clearfix">
 <div id="products_style">
  ...
  <?php if(is_array($goods_show)): $i = 0; $__LIST__ = $goods_show;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
        ...
        <td class="td-manage">
          <a title="编辑"  href="<?php echo U('Home/Goods/edit',array('id'=>$vo['id']));?>"  class="btn btn-xs btn-info" target="_self"><i class="icon-edit bigger-120"></i></a> 
          <a title="删除" href="<?php echo U('Home/Goods/delete',array('id'=>$vo['id']));?>"  class="btn btn-xs btn-warning" target="_self"><i class="icon-trash  bigger-120"></i></a>
       </td>
