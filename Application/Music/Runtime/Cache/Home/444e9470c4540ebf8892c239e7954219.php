...
<div class=" page-content clearfix">
 ...
 <div><a href="<?php echo U('Home/Category/addGoods',array('id'=>$good['id']));?>">添加商品</a></div>
  ...
  <?php if(is_array($goods_show)): $i = 0; $__LIST__ = $goods_show;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
        ...
        <td class="td-manage">
          <a title="删除" href="<?php echo U('Home/Category/delGoods',array('goods_id'=>$vo['id'],'category_id'=>$good['id']));?>"  class="btn btn-xs btn-warning" target="_self"><i class="icon-trash  bigger-120"></i></a>
       </td>
