...
<!--main_top-->
  ...
  <tr>
    ...
    <form method="post" action="<?php echo U('Home/Auth/edit');?>">
    ...
    <input type="hidden" name="id" value="<?php echo ($rules['id']); ?>">
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        ...
        <input type="text" name="name" value="<?php echo ($rules['name']); ?>" class="text-word">
        </td>
        </tr> 
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        <td align="right" valign="middle" class="borderright borderbottom bggray">权限规则：</td>
        <td align="left" valign="middle" class="borderright borderbottom main-for">
        <input type="text" name="title" value="<?php echo ($rules['title']); ?>" class="text-word">
        </td>
        </tr>
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
