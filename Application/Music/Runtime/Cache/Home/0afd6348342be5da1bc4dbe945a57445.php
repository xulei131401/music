...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
  <tr>
    <td width="99%" align="left" valign="top">专辑位置：<?php echo ($good["name"]); ?></td>
  </tr>
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="search">
  		<tr>
   		 <td width="90%" align="left" valign="middle">
	         ...
	         <form method="post" action="/music/index.php/Home/Excellent/song_list/id/<?php echo ($good["id"]); ?>">
	         <span>歌曲：</span>
	         <input type="text" name="name" value="" class="text-word">
              <input type="submit" value="查询" class="text-but">
	         </form>

           <td width="10%" align="center" valign="middle" style="text-align:right; width:150px;"><a href="<?php echo U('Home/Excellent/add',array('id'=>$id));?>" target="_self" onFocus="this.blur()" class="add">新增歌曲</a></td>
         </td>
  		</tr>
	</table>
    <!-- 歌曲查询要做 -->
  ...
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
      ...
      <!-- 循环所有歌曲 -->
      <?php if(is_array($songlist)): $k = 0; $__LIST__ = $songlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
      <td align="center" valign="middle" class="borderright borderbottom"><?php echo ($vo["id"]); ?></td>
        ...
        <td align="center" valign="middle" class="borderbottom">
              <a href="<?php echo U('Home/Excellent/del',array('id'=>$id,'song_id'=>$vo['id']));?>">删除</a>
        </td>
      </tr>
  ...
  <tr>
    <td align="left" valign="top" class="fenye" style="text-align:center;"><?php echo ($page); ?></td>
  </tr>
</table>
</body>
</html>