...
<!--main_top-->
  ...
  <tr>
    ...
    <form method="post" action="<?php echo U('Home/Group/edit');?>">
    <input type="hidden" name="id" value="<?php echo ($group['id']); ?>">
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        <td align="right" valign="middle" class="borderright borderbottom bggray">管理组名称：</td>
        <td align="left" valign="middle" class="borderright borderbottom main-for">
        <input type="text" name="title" class="text-word" value="<?php echo ($group['title']); ?>">
        </td>
        </tr> 
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        <td align="right" valign="middle" class="borderright borderbottom bggray">管理组规则：</td>
        <td align="left" valign="middle" class="borderright borderbottom main-for">
            <?php if(is_array($rules)): foreach($rules as $key=>$rule): ?><input type="checkbox" name="rules[]" value="<?php echo ($rule["id"]); ?>"/><?php echo ($rule["title"]); ?>&nbsp;&nbsp;<?php endforeach; endif; ?>
        </td>
        </tr>
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
