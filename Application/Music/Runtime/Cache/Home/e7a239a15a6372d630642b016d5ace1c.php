								...
								<div id="login-box" class="login-box widget-box no-border visible">
									<div class="widget-body">
										<div class="widget-main">
											...
											<div class="login_icon"><img src="<?php echo C('T_URL');?>/images/login.png" /></div>

											<form method="post" action="<?php echo U('Home/Login/isLogin');?>">
												<fieldset>
													...
													<label class="block clearfix">
														<span class="block input-icon input-icon-right">
															...
															<i class="icon-lock"></i>
															<img src="<?php echo U('Home/Common/verify');?>" alt="验证码" width="125px" onclick="this.src='<?php echo U('Home/Common/verify');?>?code='+Math.random()">
														</span>
													</label>
