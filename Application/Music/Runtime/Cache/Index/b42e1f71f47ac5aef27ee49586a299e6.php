...
<link href="<?php echo C('T_URL');?>/css/Home/rank.css" type="text/css" rel="stylesheet">
	...
	<div id="bd">
		...
		<div id="l">
			...
			<!-- 需要循环处 -->
			<?php if(is_array($cate)): $i = 0; $__LIST__ = $cate;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if($vo['pid'] == 0): ?><h6 id="l_h4"><?php echo ($vo['name']); ?></h6>
				<?php else: ?>
				<a href="<?php echo U('Index/Rank/index',array('id'=>$vo['id']));?>"><?php echo ($vo['name']); ?></a><br/><?php endif; endforeach; endif; else: echo "" ;endif; ?>
	
		</div>
		<div id="r">
			<div id="theme">	
				<img src="/music/<?php echo ($good['pic']); ?>" width="420px" height="70px">			
			</div>
			<div id="theme_cont">
					<div id="text">
						<?php echo ($good['desc']); ?>
			...
			<div id="r_action">
				<div id="r_a_cb">&nbsp;<input type="checkbox" name="allcheck" id="quanxuan">&nbsp;&nbsp;全选</div>
				<input type="image" name="song" src="<?php echo C('T_URL');?>/images/all_play.png" id="r_a_pic_1">				
				<input type="image" name="song" src="<?php echo C('T_URL');?>/images/play.png" id="r_a_pic_2">
			</div>
			<table id="tb">
				<tr style="height:32px;border-bottom:1px solid #E0E0E0;">
					<td></td>
					<td style="width:45px;text-align:left;">名次</td>
					<td>歌曲名称</td>
					<td style="width:60px;">上榜天数</td>
					<td style="width:60px;">昨天排行</td>
					<td style="width:60px;">最高排行</td>
					<!-- <td style="width:40px;">浮动</td> -->
					<td style="width:40px;">试听</td>
					<td style="width:40px;">分享</td>
				</tr>
				<tr style="height:10px;"></tr>
				<?php if(is_array($songlist)): foreach($songlist as $k=>$vo): ?><tr>
					<td style="text-align:left;text-indent:3px;"><input type="checkbox" id="<?php echo ($vo["id"]); ?>" name="songid"></td>
					<td style="text-align:left;text-indent:5px;"><?php echo ($k+1); ?></td>
					<td style="text-align:left;width:390px;"><?php echo ($vo["singer"]); ?>&nbsp;-&nbsp;<?php echo ($vo["name"]); ?></td>
					<td>356</td>
					<td>200</td>
					<td style="width:60px">100</td>
					<!-- <td><img src="<?php echo C('T_URL');?>/images/<?php echo ($vo["float"]); ?>"></td> -->
					<td><a href="<?php echo U('Index/Audio/index',array('id'=>$vo['id']));?>"><input type="image" src="<?php echo C('T_URL');?>/images/listener.png" id="r_l_pic"></a></td>
					<td><input type="image" src="<?php echo C('T_URL');?>/images/share.png" id="r_l_pic"></td>
...
$(function () {
	$("#quanxuan").click(function(){
			if(this.checked){
				$("#tb :checkbox").attr("checked", true);
			}else{
				$("#tb :checkbox").attr("checked", false);
			}
		});
})
	//点击播放
	$('#r_a_pic_1').click(function () {
		window.location.href = "<?php echo U('Index/Audio/play',array('id'=>$id));?>";
	});
