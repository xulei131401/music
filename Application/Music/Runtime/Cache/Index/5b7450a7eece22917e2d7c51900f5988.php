	...
	<div id="dh">
		<div class="dh-l">
			<ul>
				...
				<li id="rf" style="background:#48CBFF"><a href="<?php echo U('Index/Employee/index2');?>" title="校园招聘">校园招聘</a></li>
	...
	<div id="center">
		...
		<div class="cen-cen">
				...
				<?php if(is_array($list)): foreach($list as $key=>$v): ?><div class="rrt">
						<div class="td1"><a href="/music/index.php/Index/Zhao/index4/id/<?php echo ($v["id"]); ?>"><?php echo ($v["name"]); ?></a></div>
