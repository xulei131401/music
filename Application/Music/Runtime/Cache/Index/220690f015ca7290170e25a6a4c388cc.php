...
<link rel="stylesheet" type="text/css" href="<?php echo C('T_URL');?>/css/Home/good.css">
	<script type="text/javascript" src="<?php echo C('T_URL');?>/js/jquery-1.8.3.min.js"></script>
<div id="aaa">
	<div id="l">
		<!-- 左边的标题列 -->
		<ul id="goodul">
			<li style="text-align:left;text-indent:10px;font-size:16px;" class="goodli"><strong>所有好歌</strong></li>
			<?php if(is_array($goodSong)): foreach($goodSong as $k=>$vo): ?><li id="<?php echo ($vo["id"]); ?>" class="goodli"><a href="<?php echo U('Index/Good/songlist',array('id'=>$vo['id']));?>"><?php echo ($vo["name"]); ?></a></li><?php endforeach; endif; ?>
		</ul>
	</div>
	<div id="r">
		<div>
			<a href="<?php echo U('Index/Audio/playGood',array('id'=>$id));?>"><img src="<?php echo C('T_URL');?>/images/all_play.png" alt="" style="margin-top:4px;"></a>
		</div>
		<div id="wai">
			<table style="border-top:1px solid #E6E6E6;border-bottom:1px solid #E6E6E6;width:750px;margin-top:8px;margin-left:0;margin-bottom:8px;font-size:14px;">
			
				<tr style="height:32px;border-bottom:1px solid #E0E0E0;">
					<td style="width: 45px;"><input type="checkbox" name="check" id="quanxuan">全选</td>
					<td style="width:45px;text-align:left;">编号</td>
					<td>歌曲名称</td>
